...
class _ProductRemote implements ProductRemote {
  _ProductRemote(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<ProductsModels> getProducts() async {
    ...
    final _options = _setStreamType<ProductsModels>(
    ...
    late ProductsModels _value;
    try {
      _value = ProductsModels.fromJson(_result.data!);
    } on Object catch (e, s) {
