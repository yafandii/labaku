...
import 'package:labaku/presentation/auth/sign_up/widget/item_social_media.dart';
import 'package:labaku/presentation/widgets/button/back_button.dart';
import 'package:labaku/presentation/widgets/button/base_button.dart';
import 'package:labaku/presentation/widgets/check_box/check_box_with_text.dart';
import 'package:labaku/presentation/widgets/field/base_text_input.dart';
import 'package:labaku/presentation/widgets/field/password_text_input.dart';
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text("Create your Account", style: AppFont.text42Bold),
        )
            .animate()
            .fadeIn()
            .scale()
